...
// CreateProduct provides a mock function with given fields: SellerID, ProductName, Description, CategoryID, ImageURL, Price, Quantity
func (_m *IProductService) CreateProduct(SellerID string, ProductName string, Description string, CategoryID string, ImageURL string, Price float64, Quantity int) error {
	ret := _m.Called(SellerID, ProductName, Description, CategoryID, ImageURL, Price, Quantity)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, string, string, float64, int) error); ok {
		r0 = rf(SellerID, ProductName, Description, CategoryID, ImageURL, Price, Quantity)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *IProductService) DeleteProduct(productID string) error {
...
func (_m *IProductService) GetAllProducts() ([]BusinessObjects.Product, error) {
	ret := _m.Called()
...
func (_m *IProductService) GetPaginatedProductList(searchValue string, sortBy string, productID string, sellerID string, categoryID string, pageIndex int, pageSize int, status *bool) (Util.PaginatedList[BusinessObjects.Product], error) {
...
func (_m *IProductService) GetProductByID(productID string) (BusinessObjects.Product, error) {
	ret := _m.Called(productID)
...
// GetProductPriceAfterDiscount provides a mock function with given fields: productID
func (_m *IProductService) GetProductPriceAfterDiscount(productID string) (float64, error) {
	ret := _m.Called(productID)
...
// UpdateProduct provides a mock function with given fields: productID, SellerID, ProductName, Description, CategoryID, ImageURL, Price, Quantity
func (_m *IProductService) UpdateProduct(productID string, SellerID string, ProductName string, Description string, CategoryID string, ImageURL string, Price float64, Quantity int) error {
	ret := _m.Called(productID, SellerID, ProductName, Description, CategoryID, ImageURL, Price, Quantity)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, string, string, string, float64, int) error); ok {
		r0 = rf(productID, SellerID, ProductName, Description, CategoryID, ImageURL, Price, Quantity)
	} else {
		r0 = ret.Error(0)
	}
