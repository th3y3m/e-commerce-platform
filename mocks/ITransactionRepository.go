...
func (_m *ITransactionRepository) CreateTransaction(transaction BusinessObjects.Transaction) error {
...
func (_m *ITransactionRepository) DeleteTransaction(transactionID string) error {
...
func (_m *ITransactionRepository) GetAllTransactions() ([]BusinessObjects.Transaction, error) {
	ret := _m.Called()
...
func (_m *ITransactionRepository) GetPaginatedTransactionList(sortBy string, transactionID string, orderID string, pageIndex int, pageSize int, minPrice *float64, maxPrice *float64, status *bool, startDate time.Time, endDate time.Time) (Util.PaginatedList[BusinessObjects.Transaction], error) {
...
func (_m *ITransactionRepository) GetTransactionByID(transactionID string) (BusinessObjects.Transaction, error) {
	ret := _m.Called(transactionID)
...
func (_m *ITransactionRepository) UpdateTransaction(transaction BusinessObjects.Transaction) error {
	ret := _m.Called(transaction)
